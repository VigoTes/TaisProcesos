...
class UnidadMedidaController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('GestiónUnidadMedida.listar')->with('datos','Se registro la Unidad de Medida Nº'.$unidad->codUnidadMedida);
    }
    ...
    public function update(Request $request){
        ...
        return redirect()->route('GestiónUnidadMedida.listar')->with('datos','Se edito la Unidad de Medida Nº'.$unidad->codUnidadMedida);
    }
