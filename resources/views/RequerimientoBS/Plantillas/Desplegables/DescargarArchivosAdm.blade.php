    ...
    <div class="panel panel-default">
        ...
        <div id="collapseArchivosAdm" class="panel-collapse collapse card-body p-0">
          <table class="table table-striped table-bordered table-condensed table-hover" 
            ...
            <tbody>
              @for($i = 1; $i <= $requerimiento->cantArchivosAdmin; $i++)
              <tr>
                 <td style = "padding: 0.50rem">
                  <a href="{{route('RequerimientoBS.descargarArchivoAdm',$requerimiento->codRequerimiento.'*'.$i)}}">
                 
                        <i id="" class="far fa-address-card nav-icon"></i>
                        {{$requerimiento->getNombreArchivoAdmNro($i)}}
                     </a>
                  </td>
