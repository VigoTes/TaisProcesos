...
function agregarDetalle(){
    ...
    */  
    ...
    if (!(cantidad>0)) 
        msjError="Por favor ingrese una cantidad válido.";  
    
        
    descripcion=$("#descripcion").val();    
    if(descripcion==''){ 
        msjError=("Por favor ingrese el concepto");  
    }else if(descripcion.length>{{App\Configuracion::tamañoMaximoDescripcion}} ){
        msjError=("La longitud del descripcion tiene que ser maximo de {{App\Configuracion::tamañoMaximoDescripcion}} caracteres");  
    }
