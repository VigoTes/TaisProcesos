...
Route::group(['middleware'=>"ValidarSesion"],function()
{
    ...
    Route::post('/Indicadores/agregarEditarRegistro','IndicadorController@agregarEditarRegistro')->name('Indicadores.agregarEditarRegistro');
    Route::get('/Indicadores/eliminarRegistro/{idRegistro}','IndicadorController@eliminarRegistro')->name('Indicadores.eliminarRegistro');
